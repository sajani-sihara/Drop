...
class _LoginState extends State<Login> {
  ...
  showAlertDialogResetPassword(BuildContext context) {
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
        "You will receive an email containing instructions on how to reset your password. If you didn't receive the email, please check your spam and bulk folders.",
        style: TextStyle(
          fontFamily: "Futura",
        ),
      ),
