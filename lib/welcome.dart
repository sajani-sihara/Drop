...
class _WelcomeState extends State<Welcome> {
  ...
  void initState() {
    ...
    pageLength = 5;
    image1 = Image.asset(
      "assets/images/firstpage.jpg", fit: BoxFit.cover,);
    image2 = Image.asset(
      "assets/images/secondpage.webp", fit: BoxFit.cover,);
    image3 = Image.asset(
      "assets/images/thirdpage.webp", fit: BoxFit.cover,);
    image4 = Image.asset(
      "assets/images/fourthpage.webp", fit: BoxFit.cover,);
    image5 = Image.asset(
      "assets/images/fifthpage.webp", fit: BoxFit.cover,);
            ...
            child: Container(
              ...
              child: FlatButton.icon(
                onPressed: () {
                  Navigator.push(
                    context,
                    FadeRoute(page: EmailVerification(backgroundImage: signupImage,)),
                  );
                },
